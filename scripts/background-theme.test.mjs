...
assert.match(prompt, /Ambient life:/);
...
assert.match(prompt, /few birds in the sky or tiny distant human silhouettes/i);
assert.match(prompt, /keep them secondary and unobtrusive/i);
